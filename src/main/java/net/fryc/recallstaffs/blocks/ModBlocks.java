...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block){
        ...
        return Registry.register(Registry.BLOCK, new Identifier(RecallStaffs.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block){
        return Registry.register(Registry.ITEM, new Identifier(RecallStaffs.MOD_ID, name),
